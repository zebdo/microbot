...
public class ShortestPathPlugin extends Plugin implements KeyListener {
    ...
    /**
     * Writes the NexusPortal TSV data to the ShortestPathPlugin resources directory.
    ...
    public static void writePohToTsv(String content, String fileName) {
        try {
            ...
            java.net.URL resourceUrl = ShortestPathPlugin.class.getResource("transports.tsv");
