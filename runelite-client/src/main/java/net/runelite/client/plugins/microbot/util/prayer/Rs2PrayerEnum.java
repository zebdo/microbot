...
public enum Rs2PrayerEnum {
    ...
    DEAD_EYE("Deadeye", InterfaceID.Prayerbook.PRAYER21, 44, VarbitID.PRAYER_DEADEYE, 22),
    MYSTIC_MIGHT("Mystic Might", InterfaceID.Prayerbook.PRAYER24, 45, VarbitID.PRAYER_MYSTICMIGHT, 23),
    MYSTIC_VIGOUR("Mystic Vigour", InterfaceID.Prayerbook.PRAYER24, 45, VarbitID.PRAYER_MYSTICVIGOUR, 23),
