...
public class Constants {
    ...
    public static final Set<Integer> PORTAL_NEXUS_IDS = ImmutableSet.of(
        ...
        public static final Set<Integer> MOONLIGHT_MOTH_MIX_IDS = ImmutableSet.of(                
                ItemID.HUNTER_MIX_MOONMOTH_1DOSE,
                ItemID.HUNTER_MIX_MOONMOTH_2DOSE                                
        );
         public static final Set<Integer> MOONLIGHT_POTION_IDS = ImmutableSet.of(                
                ItemID._1DOSEMOONLIGHTPOTION,
                ItemID._2DOSEMOONLIGHTPOTION,
                ItemID._3DOSEMOONLIGHTPOTION,
                ItemID._4DOSEMOONLIGHTPOTION
        );
}