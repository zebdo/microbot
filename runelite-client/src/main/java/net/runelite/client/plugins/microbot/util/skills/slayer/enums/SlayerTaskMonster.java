package net.runelite.client.plugins.microbot.util.skills.slayer.enums;
...
public enum SlayerTaskMonster {
    ...
    WYRM("Wyrm", 62, new String[]{"Karuulm Slayer Dungeon"}, new String[]{"Boots of stone", "Boots of brimstone", "Granite boots"}, new String[]{"Draconic"}, new String[]{"Melee", "Magical ranged"}, new String[]{"None"}, new String[]{"Chaeldar", "Konar quo Maten", "Nieve", "Duradel"}),
    ...
    SlayerTaskMonster(String monster, int slayerLevel, String[] locations, String[] itemsRequired,
                      String[] attributes, String[] attackStyles, String[] alternatives, String[] slayerMasters) {
