...
public class ExamplePrePostScheduleRequirements extends PrePostScheduleRequirements {
    ...
    protected boolean initializeRequirements() {
        ...
        this.register(new LocationRequirement(BankLocation.GRAND_EXCHANGE, true,-1,ScheduleContext.PRE_SCHEDULE, RequirementPriority.RECOMMENDED));        
        ...
        this.register(new ItemRequirement(
            ...
            EquipmentInventorySlot.HEAD, RequirementPriority.RECOMMENDED, 8, "Graceful hood for weight reduction",scheduleContext
        ));
        this.register(new ItemRequirement(
            ItemID.VIKING_HELMET,
            EquipmentInventorySlot.HEAD, RequirementPriority.RECOMMENDED, 5, "Basic head protection",scheduleContext
        ));
        
        // CAPE - Example with skill requirements
        this.register(new ItemRequirement(
            ItemID.GRACEFUL_CAPE,
            EquipmentInventorySlot.CAPE, RequirementPriority.RECOMMENDED, 8, "Graceful cape for weight reduction", scheduleContext
        ));
        ...
        this.register(new ItemRequirement(
            ...
            EquipmentInventorySlot.AMULET, RequirementPriority.RECOMMENDED, 4, "Basic amulet of power", scheduleContext
        ));
        
        // BODY - Example weight reduction focus
        this.register(new ItemRequirement(
            ItemID.GRACEFUL_TOP,
            EquipmentInventorySlot.BODY, RequirementPriority.RECOMMENDED, 8, "Graceful top for weight reduction",scheduleContext
        ));
        this.register(new ItemRequirement(
            ItemID.HARDLEATHER_BODY,
            EquipmentInventorySlot.BODY, RequirementPriority.RECOMMENDED, 3, "Basic leather body",scheduleContext
        ));
        
        // LEGS - Continue weight reduction theme
        this.register(new ItemRequirement(
            ItemID.GRACEFUL_LEGS,
            EquipmentInventorySlot.LEGS, RequirementPriority.RECOMMENDED, 8, "Graceful legs for weight reduction",scheduleContext
        ));
        this.register(new ItemRequirement(
            ItemID.LEATHER_CHAPS,
            EquipmentInventorySlot.LEGS, RequirementPriority.RECOMMENDED, 3, "Basic leather chaps",scheduleContext
        ));
        
        // BOOTS - Complete the graceful set
        this.register(new ItemRequirement(
            ItemID.GRACEFUL_BOOTS,
            EquipmentInventorySlot.BOOTS, RequirementPriority.RECOMMENDED, 8, "Graceful boots for weight reduction",scheduleContext
        ));
        this.register(new ItemRequirement(
            ItemID.LEATHER_BOOTS,
            EquipmentInventorySlot.BOOTS, RequirementPriority.RECOMMENDED, 3, "Basic leather boots",scheduleContext
        ));
        
        // GLOVES - Graceful gloves to complete the set
        this.register(new ItemRequirement(
            ItemID.GRACEFUL_GLOVES,
            EquipmentInventorySlot.GLOVES, RequirementPriority.RECOMMENDED, 8, "Graceful gloves for weight reduction",scheduleContext
        ));
        this.register(new ItemRequirement(
            ItemID.LEATHER_GLOVES,
            EquipmentInventorySlot.GLOVES, RequirementPriority.RECOMMENDED, 3, "Basic leather gloves",scheduleContext
        ));
        
        // INVENTORY ITEMS - Example tools and supplies
        this.register(new ItemRequirement(
            ItemID.COINS, 1, -1,
            RequirementPriority.RECOMMENDED, 9, "Coins for purchases and teleports",scheduleContext
        ));
       
        this.register(ItemRequirement.createOrRequirement(
            Arrays.asList(ItemID.LOBSTER, ItemID.SWORDFISH, ItemID.TUNA), 1, null,-1,
            RequirementPriority.RECOMMENDED, 5, "Food for healing if needed",scheduleContext
        ));
        setInitialized(true);
