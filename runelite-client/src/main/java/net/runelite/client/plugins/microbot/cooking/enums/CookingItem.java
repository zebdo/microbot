...
public enum CookingItem
{
	...
	RAW_ANCHOVIES("raw anchovies", ItemID.RAW_ANCHOVIES, 1, "anchovies", ItemID.ANCHOVIES, "burnt fish", 0, CookingAreaType.BOTH),
	RAW_SARDINE("raw sardine", ItemID.RAW_SARDINE, 1, "sardine", ItemID.SARDINE, "burnt fish", 0, CookingAreaType.BOTH),
	RAW_HERRING("raw herring", ItemID.RAW_HERRING, 5, "herring", ItemID.HERRING, "burnt fish", 0, CookingAreaType.BOTH),
	RAW_MACKEREL("raw mackerel", ItemID.RAW_MACKEREL, 10, "mackerel", ItemID.MACKEREL, "burnt fish", 0, CookingAreaType.BOTH),
	RAW_TROUT("raw trout", ItemID.RAW_TROUT, 15, "trout", ItemID.TROUT, "burnt fish", 0, CookingAreaType.BOTH),
	RAW_COD("raw cod", ItemID.RAW_COD, 18, "cod", ItemID.COD, "burnt fish", 0, CookingAreaType.BOTH),
	RAW_PIKE("raw pike", ItemID.RAW_PIKE, 20, "pike", ItemID.PIKE, "burnt fish", 0, CookingAreaType.BOTH),
	RAW_SALMON("raw salmon", ItemID.RAW_SALMON, 25, "salmon", ItemID.SALMON, "burnt fish", 0, CookingAreaType.BOTH),
	RAW_TUNA("raw tuna", ItemID.RAW_TUNA, 30, "tuna", ItemID.TUNA, "burnt fish", 0, CookingAreaType.BOTH),
	RAW_KARAMBWAN("raw karambwan", ItemID.TBWT_RAW_KARAMBWAN, 30, "cooked karambwan", ItemID.TBWT_COOKED_KARAMBWAN, "burnt karambwan", ItemID.TBWT_POORLY_COOKED_KARAMBWAN, CookingAreaType.BOTH),
	...
	RAW_BASS("raw bass", ItemID.RAW_BASS, 43, "bass", ItemID.BASS, "burnt fish", 0, CookingAreaType.BOTH),
	...
	RAW_SUNLIGHT_ANTELOPE("raw sunlight antelope", 0, 68, "cooked sunlight antelope", 0, "burnt antelope", 0, CookingAreaType.BOTH),
	RAW_SHARK("raw shark", ItemID.RAW_SHARK, 80, "shark", ItemID.SHARK, "burnt shark", ItemID.BURNT_SHARK, CookingAreaType.BOTH),
	RAW_SEA_TURTLE("raw sea turtle", 0, 82, "sea turtle", 0, "burnt sea turtle", 0, CookingAreaType.BOTH),
	...
	RAW_MANTA_RAY("raw manta ray", 0, 91, "manta ray", 0, "burnt manta ray", 0, CookingAreaType.BOTH),
	RAW_MOONLIGHT_ANTELOPE("raw moonlight antelope", 0, 92, "cooked moonlight antelope", 0, "burnt antelope", 0, CookingAreaType.BOTH),
