...
@Slf4j
public final class Rs2Boat
{
    private static int lastCheckedOnBoat = 0;
    private static WorldEntity boat = null;

	// Temp fix for disembark plank ids
	public static final int[] GANGPLANK_DISEMBARK = {
	...
	private static Heading currentHeading = Heading.SOUTH;
	...
	public static void handleChatMessage(ChatMessage event)
	{
		if (event.getType() == ChatMessageType.GAMEMESSAGE)
		{
			...
			{
				Microbot.getClientThread().runOnSeperateThread(Rs2Boat::trimSails);
			}
		}
	}
	...
	public static Rs2BoatModel getCurrentBoat()
	{
	...
	public static boolean navigate()
	{
		...
		sleepUntil(Rs2Boat::isNavigating, 5000);
		return isNavigating();
	}

	public static WorldPoint getPlayerBoatLocation()
	{
		var playerBoat = getBoat();
		if (playerBoat == null)
		{
			return null;
		}
	...
	public static boolean boardBoat()
	{
		...
		sleepUntil(Rs2Boat::isOnBoat, 5000);
		return isOnBoat();
	}
	...
	public static void setSails()
	{
		...
		{
			clickSailButton();
			sleepUntil(Rs2Boat::isMovingForward, 2500);
		}
	}
	...
	public static void unsetSails()
	{
		...
		{
			clickSailButton();
			sleepUntil(Rs2Boat::isStandingStill, 2500);
		}
	}
	...
	{
		WorldPoint worldPoint = Rs2Boat.getPlayerBoatLocation();
