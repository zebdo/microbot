...
public enum ShootingStarLocation
{
	...
	RALOS_RISE_MINING_SITE(new WorldPoint(1486, 3093, 0), "Mine northwest of hunter guild", "Ralos Rise Mining Site", false),
	...
	MISTROCK_MINE(new WorldPoint(1419, 2872, 0), "Aldarin mine in Varlamore", "Mistrock mine", false),
	SALVAGER_OVERLOOK_MINE(new WorldPoint(1628, 3273, 0), "Salvager Overlook in Varlamore", "Salvager Overlook mine", false),
	CUSTODIA_MOUNTAINS(new WorldPoint(1287, 3414, 0), "Custodia Mountains in Varlamore", "Custodia Mountains", false),
	;
