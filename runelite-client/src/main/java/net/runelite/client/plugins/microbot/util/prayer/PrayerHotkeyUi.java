...
import net.runelite.api.widgets.ScriptEvent;
...
public class PrayerHotkeyUi
{
        ...
        @Inject
        PrayerHotkeyUi(Client client, EventBus eventBus, PrayerHotkeyAssignments assignments)
        {
                this.client = client;
